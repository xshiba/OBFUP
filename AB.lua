...
if string.lower(a) == game:GetService("RbxAnalyticsService"):GetClientId() then
	...
	PidUi.Name = " "
	PidUi.Parent = game:GetService("Players").LocalPlayer.PlayerGui
	...
	Main.MouseButton1Click:Connect(function()
		game:GetService("Players").LocalPlayer.PlayerGui[''].Main.Visible = not game:GetService("Players").LocalPlayer.PlayerGui[''].Main.Visible
	end)
